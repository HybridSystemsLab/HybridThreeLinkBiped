...
public class ReferenceJumpController implements Controller<VirtualBipedState, BipedInput, TrajectoryParameters>, Indexed
{
	...
	public TrajectoryParameters uC(VirtualBipedState state, BipedInput input, ArrayList<Object> params)
	{
		...
		BipedState x0 = BipedComputer.computeChangeAtImpact(state, bipedParams);
		BipedState xf = equilib.getFinalState();
		double tPlus = BipedComputer.computeStepTime(bipedParams);
